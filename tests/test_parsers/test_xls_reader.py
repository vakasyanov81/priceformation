...
import pytest
from parsers.xls_reader import XlsReader, __SKIPPED_EMPTY_ROW__
...
SHEET_1 = [
    ...
    {'col_0': 88538061200.0, 'col_1': 'HIFLY  185/60/14  T 82 Win-turi 212  старше 3-х лет'}
]
...
SHEET_3 = [
    {'col_0': 86015679120.0, 'col_1': 'LEMMERZ  11,75\\R22,5 10*335 ET0  d281  [2920687 alive]'},
    {'col_0': 86348478178.0, 'col_1': 'LEMMERZ  11,75\\R22,5 10*335 ET120  d281  [2920695 alive]'}
]


def make_reader():
    """ make reader """
    return XlsReader.get_instance(
        _FILE_PATH,
        _PARSE_PARAMS
    )
