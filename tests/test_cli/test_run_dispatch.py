...
def test_run_machine_json_dispatch() -> None:
    ...
    with (
        ...
        mock_json.assert_called_once_with("parse", all_result=False, result_template=None)
...
def test_run_machine_json_all_result_dispatch() -> None:
    ...
    with (
        ...
        mock_json.assert_called_once_with("parse", all_result=True, result_template=None)
...
def test_json_passes_result_template() -> None:
    ...
    with (
        ...
        mock_json.assert_called_once_with("parse", all_result=False, result_template="for_drom")
