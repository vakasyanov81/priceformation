...
def test_get_try_to_int_or_float() -> None:
    ...
    assert get_try_to_int_or_float("10") == 10
    assert get_try_to_int_or_float("10.0") == 10
    assert get_try_to_int_or_float("10.5") == 10.5
...
def test_get_integer() -> None:
    ...
    assert get_integer("10") == 10
    assert get_integer("10.0") == 10
    assert get_integer("10.5") == 10
