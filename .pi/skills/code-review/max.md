...
Run **10 independent finder angles** via the Task tool (`subagent_type: generalPurpose`). Each
...
verifier** via the Task tool (`subagent_type: generalPurpose`): give it the diff, the relevant
